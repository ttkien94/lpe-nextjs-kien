...
export default function Custom404() {
  ...
  return (
    <>
      <Head>
        <title>Không tim thấy trang</title>

        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta
          name="description"
          content="Trang bạn yêu cầu không tìm thấy"
        ></meta>
      ...
      <div className={styles.notFound}>
        <div className={styles.wrapperNotFound}>
          <svg className={styles.monkeyPic} viewBox="0 0 800 480">
            <path
...
c-11.4,0-20.6-9.2-20.6-20.6c0-11.4,9.2-20.6,20.6-20.6h21.2c11.4,0,20.6,9.2,20.6,20.6C353.3,177.9,344.1,187.1,332.8,187.1z"
  ...
  c0.1,0.1,0.3,0.1,0.5,0.1C191.1,322.8,191.3,322.5,191.2,322.3z"
    ...
    c0-0.1,0-0.2,0.1-0.2c0.5-0.7,0.9-1.6,0.5-2.9C166.2,345.5,165.4,344.4,164.3,344.1z"
      ...
      C163.3,304.6,165,300.3,165,296z"
            ...
            <g className={styles.tetris_path}>
              <g className={styles.tetris}>
                <path
                  id="tetris_stroke"
                  className={styles.st1}
  ...
  C445.1,269.6,446.4,268.3,448.1,268.3z"
          ...
          <h4 className="mt-5 px-2">TRANG NÀY KHÔNG TỒN TẠI</h4>

          <button
            type="button"
            className={styles.goBackButn}
            onClick={() => {
              router.back();
            }}
          >
